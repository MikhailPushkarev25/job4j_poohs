                ...
                pool.execute(
                        () -> {
                            try (OutputStream out = socket.getOutputStream();
                                ...
                                var total = input.read(buffer);
                                var content = new String(Arrays.copyOfRange(buffer, 0, total), StandardCharsets.UTF_8);
